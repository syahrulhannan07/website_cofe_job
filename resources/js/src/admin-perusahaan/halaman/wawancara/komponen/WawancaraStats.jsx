...
const WawancaraStats = ({ stats }) => {
    return (
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 mb-10">
            <div className="w-full sm:w-[246px] h-[83px] bg-[#EBE4DC] border border-black/5 px-6 rounded-[10px] flex flex-col justify-center">
            ...
            <div className="w-full sm:w-[246px] h-[83px] bg-[#DBFFED] border border-[#519565]/30 px-6 rounded-[10px] flex flex-col justify-center">
