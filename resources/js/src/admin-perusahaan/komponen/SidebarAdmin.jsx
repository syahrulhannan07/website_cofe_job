...
const SidebarAdmin = ({ menuAktif, setMenuAktif, menanganiLogout, sidebarTerbuka, setSidebarTerbuka }) => {
    ...
    return (
        <>
            ...
            <aside
                className={`
                    sidebar-admin w-[280px] min-w-[280px] h-full bg-[#4B2E2B] flex flex-col rounded-r-[20px] overflow-y-auto
