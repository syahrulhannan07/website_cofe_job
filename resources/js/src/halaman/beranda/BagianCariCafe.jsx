            ...
            >
                ...
                >
                    {[1, 2, 3, 4].map((item) => (
                        <div 
                            key={item} 
                            className="flex flex-col items-center relative bg-[#C69C6D] rounded-[50px] border-[1px] border-[#4B2E2B] w-full lg:w-[317px] h-[317px] shrink-0"
                        >
                            {/* Logo */}
                            ...
                            <div className="flex items-center justify-center relative w-full mt-[30px]">
                                <div className="flex items-center justify-center relative w-[198px] h-[42px] bg-[#F3EDE6] rounded-[5px]">
