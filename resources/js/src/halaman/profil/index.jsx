...
const Profil = () => {
    ...
    useEffect(() => {
        if (location.state?.bukaGantiPassword) {
            setIsModalPasswordOpen(true);
    ...
    return (
        <div className="wadah-halaman-profil w-full font-poppins flex flex-col overflow-x-hidden bg-[#F3EDE6]">
            <main className="area-konten-utama flex-1 flex flex-col items-center py-8 md:py-12 px-4 relative">
                <div className="kontainer-halaman w-full max-w-5xl flex flex-col gap-6 z-10">
                    <div className="baris-info-utama flex flex-col lg:flex-row gap-6 items-stretch">
                        <div className="sisi-kiri-informasi lg:flex-1 order-2 lg:order-1 flex flex-col">
                            <FormInformasiPribadi initialData={profilData} onRefresh={refreshData} />
                        </div>

                        <div className="sisi-kanan-foto lg:w-[280px] order-1 lg:order-2 flex flex-col">
