...
const HalamanErrorKopi = ({ code = 404, message = "Oops! Cangkir ini sepertinya kosong.", subMessage = "Halaman yang Anda cari mungkin sudah dipindahkan atau koneksi sedang terganggu. Mari kembali ke bar utama." }) => {
    ...
    return (
        <div className="fixed inset-0 z-[1100] bg-[#F3EDE6] flex flex-col items-center justify-center p-6 text-center">
            ...
            >
                ...
                <p className="font-poppins text-[16px] text-[#4B2E2B]/70 mb-8 whitespace-pre-line">
                    {subMessage}
                </p>
